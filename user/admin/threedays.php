                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    date_default_timezone_set("Asia/Manila"); 
                                     ...
                                     $expiring2 = date("Y-m-d",strtotime($date. " + 3 days"));                                
                                        ...
                                        $query1=mysqli_query($con,"select * from blood_exam LEFT JOIN donation ON donation.donation_id = blood_exam.donation_id LEFT JOIN donor ON donor.donor_id = donation.donor_id WHERE expiry <= '$expiring2' AND  expiry >= '$date' ")or die(mysqli_error($con));
