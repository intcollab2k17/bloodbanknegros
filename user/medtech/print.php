 ...
 <html>
    ...
    <body>
        <div class="header">
            ...
            Negros First Provincial Blood Center<br>
            Province of Negros Occidental</h5>
...
<?php   
    ...
    $query1=mysqli_query($con,"select * from donation natural join donor natural join program where donation_id='$id'")or die(mysqli_error($con));
...
?>          
        <table width="100%">
            <tr>
                ...
                <td colspan="6"> VENUE: <?php echo $row1['program_address'];?></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>Age : <?php 
                            $age = date_create($row1['donor_bday'])->diff(date_create('today'))->y;
                               echo $age;
                            ?>  </td>
                <td>Gender : ( <?php if($row1['donor_gender']=="male") echo "/";?> )M ( <?php if($row1['donor_gender']=="female") echo "/";?> )F</td>
...
<?php   
    ...
    $querype=mysqli_query($con,"select * from physical_exam natural join user where donation_id='$id'")or die(mysqli_error($con));
            $rowpe=mysqli_fetch_array($querype);
?>                        
            <tr>
                <td>METHOD OF COLLECTION : </td>
                <td>( <?php
                if($rowpe['method']=="Conventional")
                 echo "/";?> ) WHOLE BLOOD (conventional)</td>
                <td>( <?php
                if($rowpe['method']=="Pheresis")
                 echo "/";?> ) Pheresis</td>
            </tr>
            <tr>
                <td>LAST DONATION : </td>
...
<?php $i++;}}?>
            ...
            <tr>
                ...
                <td colspan="3" style="text-align: center"><u><?php echo $rowpe['user_first']." ".$rowpe['user_middle']." ".$rowpe['user_last'];?></u><br>
                    Medical Officer</td>
            </tr>
            <tr>
                <td>REASON/S FOR DEFERRAL: </td>
            </tr>
            <tr>
                <td><?php echo $rowpe['reasons_for_deferral'];?></td>
            </tr>
            <tr>
                <td>Place Barcode Sticker of Donation ID No. 
                    <div style="border:1px solid;height: 70px"></div>                    
                </td>
                <td colspan="3" style="text-align: center">Blood Bank Officer</td>
            </tr>
            <tr>
...
<?php   
    ...
    $querybe=mysqli_query($con,"select * from blood_exam natural join user where donation_id='$id'")or die(mysqli_error($con));
...
?>              
            ...
            <tr>
                <td>Time Started: </td>
                <td><?php echo date("h:i A",strtotime($rowbe['time_started']));?></td>
            </tr>
            <tr>
                <td>Time Ended: </td>
                <td><?php echo date("h:i A",strtotime($rowbe['time_ended']));?></td>
            </tr>
            <tr>
                <td>Phlebotomist: </td>
